    ...
    signup(){
        ...
        meter.addFocusListener(new FocusListener(){
            ...
            public void focusLost(FocusEvent fe){
                try{
                    Conn c=new Conn();
                    ResultSet rs=c.s.executeQuery("select * from logins where meter_no='"+meter.getText()+"'");
                    while(rs.next()){
        ...
        if(ae.getSource()==create){
            ...
            try{
                ...
                if(atype.equals("Admin")){
                       query="insert into logins values(' ','"+susername+"','"+aname+"','"+spassword+"','"+atype+"')";
                }else{
                    query="update logins set username= '"+susername+"',password='"+spassword+"',user='"+atype+"'where meter_no='"+smeter+"'";
                }
